  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute right-1/4 top-1/4 h-64 w-64 rounded-full bg-emerald-100/40 blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 h-64 w-64 rounded-full bg-teal-100/40 blur-3xl" />
      </div>
